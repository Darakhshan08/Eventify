...
header('location:logout.php');
	...
	$sql="update  tbl_user set full_name=:fname,user_email=:emailid,user_phoneno=:pnumber where user_id=:uid ";
	//preparing the query
...
<br>
		...
		<div class="tap">
			<h6 style="margin-left: 13px; font-size:35px;"><?php echo htmlentities($result->full_name);?>'s Profile &nbsp;</h6>
			<h6 style="margin-left: 13px;">Reg. Date:<?php echo htmlentities($result->user_reg_date);?> </h6>
<?php if($result->last_updationdate!=""){?>

			<h6 style="margin-left: 13px;">Last Updation Date:<?php echo htmlentities($result->last_updationdate);?> </h6>
<?php } ?>
<br>
      ...
      <label>Your Full Name<span>*</span></label>
				<input type="text" class="form-control main" name="name" value="<?php echo htmlentities($result->full_name);?>" >
			</div>
			<div class="col-md-6">
      <label>Your Password<span>*</span></label>
				<input type="text" class="form-control main" name="username" value="<?php echo htmlentities($result->user_name);?>" placeholder="Enter Your Password">
			</div>
			<div class="col-md-6">
      <label>Your Email<span>*</span></label>
				<input type="email" class="form-control main" name="email" value="<?php echo htmlentities($result->user_email);?>" placeholder="Enter Your Email">
			</div>
			<div class="col-md-6">
      <label>Your Phone Number<span>*</span></label>
				<input type="text" class="form-control main" name="phonenumber" value="<?php echo htmlentities($result->user_phoneno);?>" placeholder="Enter Your Phone Number">
			</div>
			<div class="frame">
				<a href=""><button class="custom-btn btn-9" type="submit" name="update" style="margin-left: 13px;">UPDATE</button></a>
			   </div>
		</form>
	</div>
<?php }} ?>
