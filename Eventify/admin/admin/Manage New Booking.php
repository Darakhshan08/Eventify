...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['search_button'])) {
    ...
    $sql = "SELECT 
    b.booking_id, b.booking_status, b.booking_date, b.no_member,
    e.event_name,
    u.full_name
FROM 
tbl_booking AS b
LEFT JOIN 
tbl_events AS e ON b.event_id = e.id 
LEFT JOIN 
tbl_user AS u ON b.user_id = u.user_id
WHERE  
b.booking_status IS NULL
    AND (e.event_name LIKE :search_query OR u.full_name LIKE :search_query)";
...
// Fetch all data
$sqlAll = "SELECT tbl_booking.id as bid,tbl_booking.booking_id,tbl_events.event_name,tbl_user.full_name,tbl_booking.no_member,tbl_booking.booking_status,tbl_booking.booking_date from tbl_booking left  join tbl_user on tbl_user.user_id =tbl_booking.user_id left join tbl_events on tbl_events.id=tbl_booking.event_id where tbl_booking.booking_status is null LIMIT $recordsPerPage OFFSET $offset";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="font-size: 35px; width:400px; ">Manage New Bookings</h4>
                    </div>
                                       ...
                                       ?></td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="booking-Details.php?bkid=<?php echo htmlentities($row->bid);?>"><i class="fa fa-print  m-r-5"></i></a>
