...
// Fetch all data
$status='Cancelled';
$sqlAll = "SELECT tbl_booking.id as bid,tbl_booking.booking_id,tbl_events.event_name,tbl_user.full_name,tbl_booking.no_member,tbl_booking.booking_status,tbl_booking.booking_date from tbl_booking left  join tbl_user on tbl_user.user_id =tbl_booking.user_id left join tbl_events on tbl_events.id=tbl_booking.event_id where tbl_booking.booking_status='Cancelled' LIMIT $recordsPerPage OFFSET $offset ";
