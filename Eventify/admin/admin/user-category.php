...
{
$id=$_GET['del'];
$sql = "delete from tbl_usrcategory  WHERE uc_id=:id";
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['search_button'])) {
    ...
    $sql = "SELECT * FROM tbl_usrcategory WHERE uc_name LIKE :search_query";
...
// Fetch all data
$sqlAll = "SELECT * FROM tbl_usrcategory  LIMIT $recordsPerPage OFFSET $offset"; // Concatenate values directly";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="font-size: 40px;">User Category</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-user-category.php" class="btn btn  btn-rounded float-right" style="background-color: #9a28d7; color: white;">Add Category</a>
                    </div>
                </div>
    ...
    <?php if ($showFetchedData): ?>
        <?php foreach ($allResults as $row): ?>
									...
									<tr>
										...
										<td><?php echo htmlentities($row->uc_name);?></td>
										<td><?php echo htmlentities($row->uc_discription);?></td>
										<td><?php echo htmlentities($row->uc_creationdate);?></td>
										<td>
                                        <?php $status=$row->Is_Active;
if($status==1):
...
?>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="edit-user-category.php?uc_id=<?php echo htmlentities($row->uc_id);?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content" style="background: url(assets/img/stars.jpg);">
                    ...
                    <form action="" method="POST">
                        ...
                        <a  class="btn btn-danger" href="user-category.php?php echo htmlentities($row->uc_id);?>">Delete</a>
                            </form>
						</div>
                                    <?php $cnt++;
         ?>  
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content" style="background: url(assets/img/stars.jpg);">
                    ...
                    <form action="" method="POST">
						...
						<h3 style="color: white;">Are you sure you want to delete this?</h3>
						<div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
                        <a  class="btn btn-danger" href="user-category.php?del=<?php echo htmlentities($row->uc_id);?>">Delete</a>
                            </form>
						</div>
                                    <?php $cnt++;
         ?>  
