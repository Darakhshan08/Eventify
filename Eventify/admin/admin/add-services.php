    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title" style="font-size: 44px; text-align: Center; top: 90px; margin-left: 0;">Add Services</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                ...
                if(isset($_POST['add'])) {
                    $cat=$_POST['service'];
                    $decrption=$_POST['price'];
                    $status=1;
                    $sql="INSERT INTO  tbl_services(ser_name,ser_price) VALUES(:service,:price)";
                    $query = $conn->prepare($sql);
                    $query->bindParam(':service',$cat,PDO::PARAM_STR);
                    $query->bindParam(':price',$decrption,PDO::PARAM_STR);
                    $query->execute();
                ...
                <form style="margin-left: 15px; margin-right: 15px;" method="POST">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Services_Price</label>
                                <input class="form-control" type="text" name="price">
                            </div>
                        </div>

                        <div class="col-sm-12 text-center">
                            <button class="btn btn-primary submit-btn" type="submit" name="add" style="background-color: #9a28d7;">Add servcies</button>
                        </div>
                    </div>
                </form>
            </div>
