...
$sql = "SELECT ser_price from tbl_services WHERE ser_id=:id";
...
{ 
$path="sponser/".$row->sponsers_logo;
}} 
// unlink($path);
$sql = "delete from tbl_services  WHERE ser_id=:id";
$query = $conn->prepare($sql);
$query -> bindParam(':id',$sid, PDO::PARAM_STR);
$query -> execute();

$_SESSION['delmsg']="Services deleted";
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['search_button'])) {
    ...
    $sql = "SELECT * FROM tbl_services WHERE ser_name LIKE :search_query";
...
// Fetch all data
$sqlAll = "SELECT * FROM tbl_services LIMIT $recordsPerPage OFFSET $offset";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="font-size: 40px;">User Services</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-services.php" class="btn btn btn-primary btn-rounded float-right" style="background-color: #9a28d7; color: white;"><i class="fa fa-check"></i> Add Services</a>
                    </div>
                </div>
 ...
 <?php if ($showFetchedData): ?>
    <?php foreach ($allResults as $row): ?>
                                     ...
                                     <td><?php echo htmlentities($cnt);?></td>
                                        <td><?php echo htmlentities($row->ser_name);?></td>
                                        <td><?php echo htmlentities($row->ser_price);?></td>
                                       <td><?php echo htmlentities($row->ser_posting_date);?></td>
        ...
        <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="edit-services.php?ser_id=<?php echo htmlentities($row->ser_id);?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="background: url(assets/img/stars.jpg);">
                    ...
                    <form action="" method="POST">
                        ...
                        <a  class="btn btn-danger" href="services.php?del=<?php echo htmlentities($row->ser_id);?>">Delete</a>
                            </form>
                        </div>
                        <?php $cnt++;
         ?>  
