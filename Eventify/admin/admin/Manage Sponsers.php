...
$sql = "SELECT sponsers_logo from tbl_sponser WHERE s_id=:id";
...
// unlink($path);
$sql = "delete from tbl_sponser  WHERE s_id=:id";
$query = $conn->prepare($sql);
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['search_button'])) {
    ...
    $sql = "SELECT * FROM tbl_sponser WHERE sponsers_name LIKE :search_query";
...
// Fetch all data
$sqlAll = "SELECT * FROM tbl_sponser LIMIT $recordsPerPage OFFSET $offset";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="font-size: 40px;">Manage Sponsers</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add sponsers.php" class="btn btn btn-primary btn-rounded float-right" style="background-color: #9a28d7; color: white;"><i class="fa fa-check"></i> Add Sponsers</a>
                    </div>
                </div>
 ...
 <?php if ($showFetchedData): ?>
    <?php foreach ($allResults as $row): ?>
                                     ...
                                     <td><?php echo htmlentities($cnt);?></td>
                                        <td><?php echo htmlentities($row->sponsers_name);?></td>
                                        <td><img src="sponser/<?php echo htmlentities($row->sponsers_logo);?>" width="120px" height="100px"></td>
        ...
        <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="edit Sponsers.php?sid=<?php echo htmlentities($row->s_id);?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="background: url(assets/img/stars.jpg);">
                    ...
                    <form action="" method="POST">
                        ...
                        <a  class="btn btn-danger" href="Manage Sponsers.php?del=<?php echo htmlentities($row->s_id);?>">Delete</a>
                            </form>
                        </div>
                        <?php $cnt++;
         ?>  
