...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['search_button'])) {
    ...
    $sql = "SELECT * FROM tbl_user WHERE full_name or user_name LIKE :search_query";
...
// Calculate the OFFSET for your query
// Fetch all data
$sqlAll = "SELECT * FROM tbl_user LIMIT $recordsPerPage OFFSET $offset";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="font-size: 40px;">Manage User</h4>
                    </div>
                            ...
                            <table class="table table-border table-striped custom-table mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th>User Name</th>
                                        <th>Status</th>
                                        <th style="min-width: 110px;">Reg.Date</th>
...
?>                  
                                        ...
                                        <td>
                                        <?php echo htmlentities($row->user_reg_date);?>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="user-booking.php?uid=<?php echo $row->user_id;?>&&uname=<?php echo $row->full_name;?>"><i class="fa fa-book m-r-5"></i>Booking</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
