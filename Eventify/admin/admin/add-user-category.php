    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title" style="font-size: 44px; text-align: Center; top: 90px; margin-left: 0;">Add Category</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                ...
                if(isset($_POST['add'])) {
                    ...
                    $status=1;
                    $sql="INSERT INTO  tbl_usrcategory(uc_name,uc_discription,Is_Active) VALUES(:cat,:decrption,:status)";
                    $query = $conn->prepare($sql);
                ...
                <form style="margin-left: 15px; margin-right: 15px;" method="POST">
                    <div class="row">
                        ...
                        <div class="col-sm-12 text-center">
                            <button class="btn btn-primary submit-btn" type="submit" name="add" style="background-color: #9a28d7;">Add Category</button>
                        </div>
                    </div>
                </form>
            </div>
