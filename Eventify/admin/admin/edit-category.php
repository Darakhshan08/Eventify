...
$sql="update tbl_category set cat_name=:cat,cat_discription=:decrption,Is_Active=:status where cat_id=:cid";
...
<div class="page-wrapper">
    <div class="content">
        ...
        <?php
        $cid=intval($_GET['catid']);
        $sql = "SELECT cat_id,cat_name,cat_discription,Is_Active,cat_updationdate from tbl_category where cat_id=:cid";
        $query = $conn -> prepare($sql);
        $query->bindParam(':cid',$cid,PDO::PARAM_STR);
        $query->execute();
        $results=$query->fetchAll(PDO::FETCH_OBJ);
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="category" value="<?php echo htmlentities($row->cat_name);?>" type="text">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="description" type="text" value="<?php echo htmlentities($row->cat_discription);?>">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            <button class="btn btn-primary submit-btn" type="submit" name="add" style="background-color: #9a28d7;">Update</button>
                        </div>
                    </div>
                </form>
            </div>
