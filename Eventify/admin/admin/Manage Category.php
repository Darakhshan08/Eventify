...
// Fetch all data
$sqlAll = "SELECT * FROM tbl_category  LIMIT $recordsPerPage OFFSET $offset"; // Concatenate values directly";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="font-size: 40px;">Manage Category</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-category.php" class="btn btn  btn-rounded float-right" style="background-color: #9a28d7; color: white;">Add Category</a>
                    </div>
                </div>
    ...
    <?php if ($showFetchedData): ?>
        <?php foreach ($allResults as $row): ?>
									...
									<tr>
										...
										<td><?php echo htmlentities($row->cat_creationdate);?></td>
										<td>
...
?>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="edit-category.php?catid=<?php echo htmlentities($row->cat_id);?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content" style="background: url(assets/img/stars.jpg);">
                    ...
                    <form action="" method="POST">
                        ...
                        <a  class="btn btn-danger" href="Manage Category.php?del=<?php echo htmlentities($row->cat_id);?>">Delete</a>
                            </form>
						</div>
                                    <?php $cnt++;
         ?>  
