...
$sql="update tbl_sponser set sponsers_logo=:slogo where s_id=:sponserid";
    ...
    <div class="content">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" name="sponserlogo" required autofocus />
            </div>

            <div class="m-t-20 text-center">
                <button class="btn btn-primary submit-btn" name="update" style="background-color: #9a28d7;">Update</button>
            </div>
        </form>
        <?php }} ?>
    </div>
