...
$sql="UPDATE  tbl_gernalsetting set site_name=:websitename,phone_no=:pnumber,email_id=:email,address=:address,footer_content=:ftext";
...
{ 
    ?>
        ...
        <style>
    /* Add CSS styles for smaller screens */
    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title" style="font-size: 40px; margin-left: -200px;">General Setting</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form action="" method="POST">
                    <?php
                    $sql = "SELECT * from tbl_gernalsetting";
                    $query = $conn->prepare($sql);
                    $query->execute();
                    $results = $query->fetchAll(PDO::FETCH_OBJ);
                    ...
                    if ($query->rowCount() > 0) {
                        foreach ($results as $row) {
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Websitename" type="text" value="<?php echo htmlentities($row->site_name);?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label>Phone Number</label>
                                <input class="form-control" type="text" name="phonenumber" value="<?php echo htmlentities($row->phone_no);?>" required>
                            </div>

                            <div class="form-group">
                                <label>Email Id</label>
                                <input class="form-control" name="emailid" type="email" value="<?php echo htmlentities($row->email_id);?>" required>
                            </div>

                            <div class="form-group">
                                <label>Address</label>
                                <input class="form-control" name="address" type="text" value="<?php echo htmlentities($row->address);?>" required>
                            </div>

                            <div class="form-group">
                                <label>Footer Text</label>
                                <input class="form-control" name="footertext" type="text" value="<?php echo htmlentities($row->footer_content);?>" required>
                            </div>
                            <?php
                        }
                    }
