...
$sql="update tbl_events set event_image=:evntimage where id=:evtid";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title"style="font-size: 40px; margin-left: -200px;">Edit Event Image</h4>
                    </div>
                </div>
                <?php
$eid=intval($_GET['evntid']);
$sql = "SELECT id,event_name,event_image,posting_date from tbl_events where id=:eid";
$query = $conn-> prepare($sql);
...
<br>
<img src="eventimages/<?php echo htmlentities($row->event_image);?>" width="170" height="150" style="margin: left 100px;" />
</div>
...
<div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="update" style="position: relative; top: 10px; margin-left: -200px; background-color:#9a28d7 ;">Update</button>
                            </div>
