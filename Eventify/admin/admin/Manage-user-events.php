...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['search_button'])) {
    ...
    e.uevent_id,
    b.uc_name,
    e.uevent_date,uevent_location,
    s.ser_name
FROM 
tbl_usrevent AS e

LEFT JOIN 
tbl_usrcategory AS b ON b.uc_id = e.uc_id 
LEFT JOIN 
tbl_services AS s ON e.ser_id  = s.ser_id
WHERE 
     s.ser_name LIKE :search_query
    OR b.uc_name LIKE :search_query";
    ...
    <div class="main-wrapper">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 class="page-title" style="font-size: 40px;">Manage User Events</h4>
                    </div>
        ...
        <?php foreach ($allResults as $row): ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlentities($row->uevent_location);?></td>
                                        <td><?php echo htmlentities($row->uevent_date);?></td>

                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="user_booking-details.php?evid=<?php echo htmlentities($row->uevent_id);?>"><i class="fa fa-print  m-r-5"></i>View Details</a>
