...
$sql="update tbl_sponser set sponsers_name=:sponser where s_id=:sponserid";
...
<div class="page-wrapper">
    <div class="content">
        ...
        <?php
        $sponserid=intval($_GET['sid']);
        $sql = "SELECT s_id,sponsers_name,sponsers_logo,posting_date from tbl_sponser where s_id=:sponserid";
        $query = $conn -> prepare($sql);
        $query->bindParam(':sponserid',$sponserid,PDO::PARAM_STR);
        $query->execute();
        $results=$query->fetchAll(PDO::FETCH_OBJ);
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="sponser" value="<?php echo htmlentities($row->sponsers_name);?>" autocomplete="off" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <br>
                                <img src="sponser/<?php echo htmlentities($row->sponsers_logo);?>" width="170" height="150" />
                                <a href="update-sponserlogo.php?sid=<?php echo htmlentities($row->s_id);?>">Update Logo</a>
                            </div>
                        </div>
                    </div>
