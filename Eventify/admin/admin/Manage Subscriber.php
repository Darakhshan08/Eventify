...
{
$id=$_GET['del'];
$sql = "delete from tbl_subscriber  WHERE sub_id=:id";
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['search_button'])) {
    ...
    $sql = "SELECT * FROM tbl_subscriber WHERE user_email LIKE :search_query";
...
// Fetch all data
$sqlAll = "SELECT * FROM tbl_subscriber 
...
<body>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="font-size: 38px; width:400px; ">Manage Subscribers</h4>
                    </div>
    ...
    <?php if ($showFetchedData): ?>
        <?php foreach ($allResults as $row): ?>
									<tr>
										<td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""><?php echo htmlentities($cnt);?></td>
										<td><?php echo htmlentities($row->user_email);?></td>
										<td style="text-align: center;"><?php echo htmlentities($row->reg_date);?></td>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content" style="background: url(assets/img/stars.jpg);">
					<div class="modal-body text-center">
                        ...
                        <a  class="btn btn-danger" href="Manage Subscriber.php?del=<?php echo htmlentities($row->sub_id);?>">Delete</a>
