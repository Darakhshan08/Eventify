...
header('location:../login.php');
  ...
  $sql="UPDATE  `admin` set a_fullname=:adminname,a_email=:adminemail";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title"style="font-size: 40px; top:20px; margin-left: 200px;">Profile Setting</h4>
                    </div>
                </div>
...
{
?>                      
                                            <div class="col-sm-6" style="position: relative; top: 20px; margin-left: 50px;">
                                                <div class="form-group" >
                                                    <label>Admin Name</label>
                                                    <input class="form-control"  name="adminname"  type="text" style="width: 700px; " value="<?php echo htmlentities($row->a_fullname);?>" required>
                                                </div>
                                            </div>
                                           
                                           
                                            <div class="col-sm-6" style="position: relative; top: 100px; margin-left: -368px;">
                                                <div class="form-group">
                                                    <label>Email Id</label>
                                                    <input class="form-control" name="adminemail" type="email"  style="width: 700px; color:white;" value="<?php echo htmlentities($row->a_email);?>" required>
                                                </div>
                                            </div>
 ...
 <div class="m-t-20 text-center">
                                <button type="submit" class="btn btn-primary submit-btn" name="update" style="position: relative; top: 120px; margin-left: 450px; background-color:#9a28d7  ;">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
