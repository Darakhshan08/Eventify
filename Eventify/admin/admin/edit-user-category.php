...
$status=$_POST['status'];
$cid=intval($_GET['uc_id']);
$sql="update tbl_usrcategory set uc_name=:cat,uc_discription=:decrption,Is_Active=:status where uc_id=:cid";
    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                ...
                <h4 class="page-title second-title">Last Updated At:</h4>
            </div>
        </div>
        <?php
        $cid=intval($_GET['uc_id']);
        $sql = "SELECT uc_id,uc_name,uc_discription,Is_Active,uc_updationdate from tbl_usrcategory where uc_id=:cid";
        $query = $conn -> prepare($sql);
        $query->bindParam(':cid',$cid,PDO::PARAM_STR);
        $query->execute();
        $results=$query->fetchAll(PDO::FETCH_OBJ);
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="category" value="<?php echo htmlentities($row->uc_name);?>" type="text">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="description" type="text" value="<?php echo htmlentities($row->uc_discription);?>">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Status</label>
                                <select class="respond" name="status" style="background: linear-gradient(rgb(45, 43, 43),rgb(124, 101, 255),black); height: 50px; border: 2px solid white;">
                                    <?php
                        ...
                        <div class="col-sm-12 text-center">
                            <button class="btn btn-primary submit-btn" type="submit" name="update" style="background-color: #9a28d7;">Update</button>
                        </div>
                    </div>
                </form>
            </div>
