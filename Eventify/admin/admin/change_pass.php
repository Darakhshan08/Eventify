...
$uid=$_SESSION['adminID'];
    $sql ="SELECT password FROM admin WHERE a_id=:uid and password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tbl_users set password=:newpassword where a_id=:uid";
            ...
            <div class="col-lg-8 offset-lg-2">
                <form method="post" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                            <input type="password" name="newpassword" class="form-control main" placeholder="Confirm Password">
